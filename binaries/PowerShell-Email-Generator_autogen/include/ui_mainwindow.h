...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalLayout_5->setSpacing(38);
        ...
        horizontalLayout_8->addWidget(selectFolderButton);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QCoreApplication::translate("MainWindow", "Attachments", nullptr));
